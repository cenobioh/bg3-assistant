...
const LOCATION_TO_ACT: { [key: string]: number } = {
  ...
  'Whispering Depths': 1,
  'Zhentarim Hideout': 1,
  'Zhentarim Basement': 1,
  'Sunlit Wetlands': 1,
  'Riverside Teahouse': 1,
  'Auntie Ethel\'s Teahouse': 1,
  'Putrid Bog': 1,
  'Riverside Village': 1,
  ...
  'The Waning Moon': 2,
  'Thorm Family Tomb': 2,
  'Mind Flayer Colony': 2,
  'Ketheric\'s Chambers': 2,
  ...
  'Stormshore Armory': 3,
  'Jungle': 3,
  'Circus of the Last Days': 3,
  'Open Hand Temple': 3,
  'Abandoned Windmill': 3,
  'Gur Camp': 3,
  'Arfur\'s Mansion': 3,
  'Arfur Mansion': 3,
  'South Span Checkpoint': 3,
  'Sword Coast Couriers': 3,
  'Rivington General': 3,
  'Angleiron\'s Cellar': 3,
  'Angleiron Cellar': 3,
  'Open Hand Temple Cellar': 3,
  'Requisitioned Barn': 3,
  'Rivington Well': 3,
  'Western Beach': 3,
};
